...
$request['WebAuthenticationDetail'] = array('UserCredential' =>
                                      array('Key' => "V8zpcZTEsjjNoFaR", 'Password' => "PMYdEk3ENajZCca4wmjCGI3of")); 
$request['ClientDetail'] = array('AccountNumber' => "510087240", 'MeterNumber' => "118551481");
...
$request['RequestedShipment']['ShippingChargesPayment'] = array('PaymentType' => 'SENDER',
                                                        'Payor' => array('AccountNumber' => "510087240", // Replace 'XXX' with payor's account number
                                                                     'CountryCode' => 'US'));
