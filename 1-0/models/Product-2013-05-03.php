...
class Product extends _Model {
	...
	public function get_product($id_product, $id_shop, $id_lang, $user_id = NULL) {
		...
		FROM (
			...
			LEFT JOIN dahliawolf_v1_2013.like_winner ON posting_product.posting_id = like_winner.posting_id
			
			INNER JOIN offline_commerce_v1_2013.product ON posting_product.product_id = product.id_product
