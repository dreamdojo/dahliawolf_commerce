...
class Product extends _Model {
	...
	public function get_product($id_product, $id_shop, $id_lang, $user_id = NULL) {
		$sql = '
		SELECT product.*, product_lang.name AS product_lang_name, shop.name AS shop_name, lang.name AS lang_name, supplier.name AS supplier, manufacturer.name AS manufacturer, default_shop.name AS default_shop_name, tax_rules_group.name AS tax_rules_group, product_lang.description, product_lang.description_short, product_lang.meta_description, product_lang.meta_keywords, product_lang.meta_title, customer.username
		FROM product 
	...
	public function get_product_files($id_product, $id_shop, $id_lang) {
		...
		WHERE product.id_product = :id_product AND shop.id_shop = :id_shop AND lang.id_lang = :id_lang
		ORDER BY product_file.created ASC, product_file.product_file_id DESC
		";
